...
for (institution_name in institutions) {
  ...
  for (model in models) {
    ...
    print(phewas_plot)
    ggsave(filename = paste0("/Users/philipcroon/PycharmProjects/Yale/DL_ECG_PheWAS/data/yale_phewas_plot_",
    ...
    write.csv(results_d,
              file = paste0("/Users/philipcroon/PycharmProjects/Yale/DL_ECG_PheWAS/yale_results_",
